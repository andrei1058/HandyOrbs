package com.andrei1058.handyorbs.hook.vault;
...
public interface VaultEconHook {
    ...
    class ActionResponse {
        ...
        public ActionResponse(Type type, boolean transactionSuccess, double amount, double balance, String errorMessage) {
            this.type = type;
