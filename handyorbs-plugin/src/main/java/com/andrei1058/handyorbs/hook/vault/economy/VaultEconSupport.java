package com.andrei1058.handyorbs.hook.vault.economy;
...
public class VaultEconSupport implements VaultEconHook {
    ...
    private ActionResponse convertResponse(EconomyResponse economyResponse) {
        return new ActionResponse(VaultEconHook.ActionResponse.Type.valueOf(economyResponse.type.name()),
                economyResponse.transactionSuccess(), economyResponse.amount, economyResponse.balance, economyResponse.errorMessage);
    }
}
